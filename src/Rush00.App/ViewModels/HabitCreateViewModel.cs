...
namespace Rush00.App.ViewModels
{
    public class HabitCreateViewModel : ViewModelBase
    {
        ...
        public ReactiveCommand<Unit, Unit> StartHabit { get; }
        public HabitCreateViewModel()
        {
            ...
            StartHabit = ReactiveCommand.CreateFromTask(
                execute: () => Task.Delay(TimeSpan.FromSeconds(1)), canExecute: canCreate);
        }
